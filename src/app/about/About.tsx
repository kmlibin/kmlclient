    ...
    <div className=" bg-customWhite flex w-full">
      ...
      <div className="relative w-1/2 flex flex-col items-start justify-start mt-[11rem] gap-10 tracking-wide pb-[8rem]">
        ...
        <p className={`w-2/3 ${ibm.className} text-md z-[20]`}>
          ...
          ligula ultricies, at luctus ex suscipit. Pellentesque eget blandit
          sapien. Phasellus a consequat leo. Proin maximus pretium ornare. Sed
          ante eros, faucibus at eleifend a, consectetur nec mi. Sed diam velit,
          tristique quis ornare a, pulvinar quis lorem. Quisque vel condimentum
          orci. Suspendisse ac diam non est ultricies hendrerit. Morbi nec
          consectetur nulla. Integer ex elit, bibendum ullamcorper diam a,
          malesuada imperdiet felis. Integer eget sem pharetra, luctus tellus
          vitae, luctus augue. Duis quis placerat tortor.
          <br></br>
          <br></br>
          ...
          Mauris eget mi lectus. Nulla ac sem aliquam justo ultricies hendrerit
          sit amet nec felis. Interdum et malesuada fames ac ante ipsum primis
          in faucibus. In porttitor sapien eget massa convallis placerat.
          Pellentesque et consectetur magna. Sed laoreet felis et libero
          vestibulum, nec interdum nisl efficitur. In tellus lorem, feugiat et
          diam a, finibus ornare risus. Quisque accumsan mollis felis ut
          tincidunt. Vivamus consectetur urna non ultricies maximus. Curabitur
          facilisis nisi quis orci feugiat, nec posuere elit ultrices.
          <br></br>
          <br></br>
          ...
          elit faucibus leo, non convallis elit tellus ac lacus. Nulla vulputate
          maximus erat sit amet sodales. Aenean id auctor metus. Fusce mollis
          magna a elementum consequat. Suspendisse sollicitudin commodo nibh ac
          vehicula. Nunc mattis faucibus dapibus. Nunc mattis tempus placerat.
        </p>
      </div>
    </div>
  );
