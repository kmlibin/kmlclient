...
const About = () => {
  return (
    <div
    className="bg-customWhite flex-col md:flex-row flex w-full relative h-full items-start overflow-hidden"
    role="region"
    aria-labelledby="about-heading"
  >
    <Icons />
    {/* Decorative Background */}
    <div className="h-full w-[100vw] absolute -mt-[7rem] md:-mt-0" aria-hidden="true">
      <div className="absolute -top-[12vh] -left-[12%] rainbow-circle w-[900px] h-[900px] 3xl:w-[1100px] rounded-full 3xl:h-[1100px]" />
      <div className="absolute -bottom-[10vh] -right-[10vw] rainbow-circle w-[500px] rounded-full h-[500px]" />
    </div>
    ...
    <div className="w-full md:w-1/2 flex flex-col items-center md:items-start justify-start md:mt-[11rem] mt-[5rem] gap-10 tracking-wide pb-[8rem]">
      ...
      <Fade direction="up" triggerOnce>
        <div
          className="w-full h-full flex items-center justify-center md:items-start md:justify-start"
          role="article"
