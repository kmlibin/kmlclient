...
const About = () => {
  return (
    <div className=" bg-customWhite flex-col md:flex-row flex w-full relative h-full items-start">
      <div className="h-full w-[100vw] overflow-x-hidden absolute -mt-[7rem] md:-mt-0">
      ...
      <div className="md:w-1/2 w-full md:mt-[180px] md:h-[100vh] flex flex-col items-center">
        ...
        <Fade delay={0.5}>
          <img
            src={kelli.src}
            alt="kelli"
            className="z-10 border-8 border-customIndigo w-2/3 sm:w-1/3 md:w-auto sm:h-[35%] mx-auto"
          />
        </Fade>
      </div>
      ...
      <div className="w-full md:w-1/2 flex flex-col items-center md:items-start justify-start md:mt-[11rem] mt-[5rem] gap-10 tracking-wide pb-[8rem]">
        ...
        <Fade direction="up" triggerOnce>
          <div className="w-full h-full flex items-center justify-center md:items-start md:justify-start ">
            <p
              className={` w-[95%] md:w-2/3 ${ibm.className} text-md z-[20] bg-customWhite bg-opacity-90 p-2 rounded-xl`}
            >
              {bio.mainText}
            </p>
          </div>
