...
const TableComparison = () => {
  return (
    <div id="comparison-table" className="hidden z-[50] sm:flex w-[95%] flex-col tracking-wide items-center justify-center border-2 border-customBlue mb-10 border-opacity-50">
