...
export const metadata: Metadata = {
  ...
  description:
    ...
    alternates: {
    canonical: "https://libinwebdevelopment.com/main/about/faq",
  },
    openGraph: {
    type: "website",
  ...
  keywords:
    "FAQ, web development questions, small business websites, custom web development, SEO FAQs, website hosting, responsive design, pricing for web development, web developer process, freelance web developer, custom-coded websites, custom website design",
};
