...
const PortfolioPage = () => {
  return (
    <div className="flex  !overflow-x-hidden sm:flex-row flex-col bg-customWhite h-full !overflow-hidden">
      {/* rainbows */}
      ...
      <div id="popup-container" className="w-full sm:w-2/3 flex z-[50] bg-customWhite sm:bg-transparent flex-col justify-center gap-4 items-center overflow-hidden mx-auto sm:mt-[180px]">
