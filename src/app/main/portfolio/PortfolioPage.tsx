...
const PortfolioPage = () => {
  const [rollImageRendered, setRollImageRendered] = useState(false);

  const handleRollImageRenderComplete = () => {
    setRollImageRendered(true);
  };
  ...
  return (
    <div className="flex lg:flex-row flex-col bg-customWhite h-full relative ">
      ...
      <div className="flex lg:w-1/3 w-full flex-col h-full items-center lg:items-end lg:justify-start relative lg:h-[300vh] 3xl:h-[230vh] md:mt-[170px] mt-[5rem]">
        ...
        <RollImage onRenderComplete={handleRollImageRenderComplete}>
            <Image
              alt="portfolio"
              src={myport}
